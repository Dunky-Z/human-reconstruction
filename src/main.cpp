...
int main()
{
	...
	mesh.read((DATASET_PATH + "/Hausdorff/male01.obj").c_str());
	clock_t t = clock();
	...
	input_m << 1701.61, 371.47, 845.81, 762.78, 784.35, 744.41, 790.41, 301.05, 740.58, 755.354, 955.55, 1185.46,
		541.92, 265.889, 166.25, 1260.27, 374.89, 518.47;
	...
	meshio::ReadObj((DATASET_PATH + "/Hausdorff/female01.obj").c_str(), verts, facets);
	Eigen::MatrixXd one_verts = verts;
